...
start() ->
  register(dataStorageProc_1, spawn(task22, dataStorageProc, [dataItem1(), []])),
	...
	register(proc_1, spawn(test, proc, ["exclusive", dataStorageProc_1])),
	register(proc_2, spawn(test, proc, ["exclusive", dataStorageProc_2])),
	register(proc_3, spawn(test, proc, ["exclusive", dataStorageProc_2])),
	register(proc_4, spawn(test, proc, ["exclusive", dataStorageProc_2])),
	register(proc_5, spawn(test, proc, ["shared", dataStorageProc_3])).
